...
public class CambioDeEscenaMapa1 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            SceneManager.LoadScene("Mapa2_Dialogos"); 
        }
    }
    ...
    private void MoverJugador(Scene scene, LoadSceneMode mode)
    {
        ...
        if (jugador != null)
        {
            jugador.transform.position = new Vector3(-7.14f, -3.91f, jugador.transform.position.z);
